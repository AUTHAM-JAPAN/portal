...
<head>
    ...
    <link rel="stylesheet" href="/assets/vendor/sky-forms/css/sky-forms.css">    
    <!--[if lt IE 9]>
        <link rel="stylesheet" href="/assets/vendor/sky-forms/css/sky-forms-ie8.css">
    <![endif]-->
...
<body>
					...
					<div class="container">
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="index.html" title="Boomerang | One template. Infinite solutions">
								<img src="http://dummyimage.com/160x50/ccc/aaa" alt="Boomerang | One template. Infinite solutions">
							</a>
						</div>
											...
											<div class="row">
												<div class="col-md-3 mega-nav-section-wr">
													<div class="mega-nav-section">
														<img src="http://dummyimage.com/1024x681/ccc/aaa" class="img-responsive img-thumbnail hidden-xs hidden-sm" alt="">
												...
												<div class="col-md-3 mega-nav-section-wr">
													<div class="mega-nav-section"> 
														<img src="http://dummyimage.com/1024x681/ccc/aaa" class="img-responsive img-thumbnail hidden-xs hidden-sm hidden-xs hidden-sm" alt="">
				...
				<div class="row">
					...
					<div class="col-lg-3">
						<a href="http://www.webpixels.ro" title="Made with love by Web Pixels" target="_blank" class="">
							<img src="http://dummyimage.com/81x22/232323/FFF" alt="Web Pixels - Designing Forward | Logo" class="pull-right">
						</a>
					</div>
				</div>
			</div>
	...
	<script src="/assets/js/jquery/jquery.mousewheel-3.0.6.pack.js"></script>
	<script src="/assets/js/jquery/jquery.easing.js"></script>
	<script src="/assets/js/jquery/jquery.metadata.js"></script>
	<script src="/assets/js/jquery/jquery.hoverup.js"></script>
	<script src="/assets/js/jquery/jquery.hoverdir.js"></script>
	<script src="/assets/js/jquery/jquery.stellar.js"></script>

	<!-- Boomerang mobile nav - Optional  -->
	<script src="/assets/vendor/responsive-mobile-nav/js/jquery.dlmenu.js"></script>
	<script src="/assets/vendor/responsive-mobile-nav/js/jquery.dlmenu.autofill.js"></script>

	<!-- Forms -->
	<script src="/assets/vendor/ui-kit/js/jquery.powerful-placeholder.min.js"></script> 
	<script src="/assets/vendor/ui-kit/js/cusel.min.js"></script>
	<script src="/assets/vendor/sky-forms/js/jquery.form.min.js"></script>
	<script src="/assets/vendor/sky-forms/js/jquery.validate.min.js"></script>
	<script src="/assets/vendor/sky-forms/js/jquery.maskedinput.min.js"></script>
	<script src="/assets/vendor/sky-forms/js/jquery.modal.js"></script>

	<!-- Assets -->
	<script src="/assets/vendor/hover-dropdown/bootstrap-hover-dropdown.min.js"></script>
	<script src="/assets/vendor/page-scroller/jquery.ui.totop.min.js"></script>
	<script src="/assets/vendor/mixitup/jquery.mixitup.js"></script>
	<script src="/assets/vendor/mixitup/jquery.mixitup.init.js"></script>
	<script src="/assets/vendor/fancybox/jquery.fancybox.pack.js?v=2.1.5"></script>
	...
	<script src="/assets/vendor/easy-pie-chart/js/jquery.easypiechart.js"></script>
	<script src="/assets/vendor/social-buttons/js/rrssb.min.js"></script>
	<script src="/assets/vendor/nouislider/js/jquery.nouislider.min.js"></script>
	<script src="/assets/vendor/owl-carousel/owl.carousel.js"></script>
	<script src="/assets/vendor/bootstrap/js/tooltip.js"></script>
	<script src="/assets/vendor/bootstrap/js/popover.js"></script>
